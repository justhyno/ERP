...
import mz.gov.mta.dndt.repository.ARepository;
...
/**
 * REST controller for managing {@link mz.gov.mta.dndt.domain.A}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AResource {
    ...
    private static final String ENTITY_NAME = "portalGisA";
