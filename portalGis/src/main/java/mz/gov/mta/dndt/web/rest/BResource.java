...
import mz.gov.mta.dndt.repository.BRepository;
...
/**
 * REST controller for managing {@link mz.gov.mta.dndt.domain.B}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BResource {
    ...
    private static final String ENTITY_NAME = "portalGisB";
