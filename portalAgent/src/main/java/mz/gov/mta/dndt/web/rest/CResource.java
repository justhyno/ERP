...
import mz.gov.mta.dndt.repository.CRepository;
...
/**
 * REST controller for managing {@link mz.gov.mta.dndt.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CResource {
    ...
    private static final String ENTITY_NAME = "portalAgentC";
