...
import mz.gov.mta.dndt.config.audit.AuditEventConverter;
import mz.gov.mta.dndt.domain.PersistentAuditEvent;
...
import static mz.gov.mta.dndt.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
