...
import mz.gov.mta.dndt.PortalBackendApp;
import mz.gov.mta.dndt.config.Constants;
import mz.gov.mta.dndt.domain.User;
import mz.gov.mta.dndt.repository.AuthorityRepository;
import mz.gov.mta.dndt.repository.UserRepository;
import mz.gov.mta.dndt.security.AuthoritiesConstants;
import mz.gov.mta.dndt.service.UserService;
import mz.gov.mta.dndt.service.dto.PasswordChangeDTO;
import mz.gov.mta.dndt.service.dto.UserDTO;
import mz.gov.mta.dndt.web.rest.vm.KeyAndPasswordVM;
import mz.gov.mta.dndt.web.rest.vm.ManagedUserVM;
...
import static mz.gov.mta.dndt.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = PortalBackendApp.class)
