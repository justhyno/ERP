...
import { CDeleteDialogComponent } from 'app/entities/c/c-delete-dialog.component';
import { CService } from 'app/entities/c/c.service';

describe('Component Tests', () => {
  describe('C Management Delete Component', () => {
    let comp: CDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CDeleteDialogComponent],
      })
        .overrideTemplate(CDeleteDialogComponent, '')
        .compileComponents();
