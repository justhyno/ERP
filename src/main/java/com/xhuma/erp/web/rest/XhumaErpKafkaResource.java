...
@RestController
@RequestMapping("/api/xhuma-erp-kafka")
public class XhumaErpKafkaResource {
    private final Logger log = LoggerFactory.getLogger(XhumaErpKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public XhumaErpKafkaResource(KafkaProperties kafkaProperties) {
